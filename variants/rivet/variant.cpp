 ...
 * | 25			| IGT              |  PB05  | IGT             | EIC/EXTINT[5]  ADC/AIN[13]           PTC/Y[11] 
 * | 26			| EMERG_OFF        |  PB06  | EMERG_OFF       | EIC/EXTINT[6]  ADC/AIN[14]           PTC/Y[12] 
 * | 27			| STATUS           |  PB07  | STATUS          | EIC/EXTINT[7]  ADC/AIN[15]           PTC/Y[13] 
 ...
 * |            | Miscellaneous    |        |                 |
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------     
 * | 34			| SDI12			   |  PB04	| SDI-12		  | EIC/EXTINT[4]  ADC/AIN[12]           PTC/Y[10] 
 * | 35			| CS_SD			   |  PB31	| CS_SD			  | EIC/EXTINT[15]                                                 SERCOM5/PAD[1]  TCC0/WO[1]   TCC1/WO[3]
 * | 36			| XBEE_RST		   |  PB00	| XBEE_RST		  | EIC/EXTINT[0]  ADC/AIN[8] 			 PTC/Y[6]                  SERCOM5/PAD[2]  TC7/WO[0]
 * | 37 		| RS485_DIR		   |  PB01  | RS485_DIR		  | EIC/EXTINT[1]  ADC/AIN[9] 			 PTC/Y[7]                  SERCOM5/PAD[3]  TC7/WO[1]
 * | 38			| RS485_TX		   |  PB02  | RS485_TX		  | EIC/EXTINT[2]  ADC/AIN[10] 			 PTC/Y[8]                 *SERCOM5/PAD[0]  TC6/WO[0]
 * | 39			| RS485_RX		   |  PB03  | RS485_RX		  | EIC/EXTINT[3]  ADC/AIN[11] 			 PTC/Y[9]                 *SERCOM5/PAD[1]  TC6/WO[1]
 * +------------+------------------+--------+-----------------+-------------------------------------------------------------------------------------------------------- 
 * |            | Wire             |        |                 |
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 40         | A4/SDA           |  PA08  | SDA             | EIC/NMI       +ADC/AIN[16]   	     PTC/X[0]  SERCOM0/PAD[0] *SERCOM2/PAD[0]  TCC0/WO[0]   TCC1/WO[2]
 * | 41         | A5/SCL           |  PA09  | SCL             | EIC/EXTINT[9] +ADC/AIN[17]           PTC/X[1]  SERCOM0/PAD[1] *SERCOM2/PAD[1]  TCC0/WO[1]   TCC1/WO[3]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * |            | SPI  			   |        |                 |
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 42         | 11               |  PA17  | MOSI            | EIC/EXTINT[1]                        PTC/X[5]  SERCOM1/PAD[1] *SERCOM3/PAD[1] +TCC2/WO[1]   TCC0/WO[7]
 * | 43         | 12               |  PA18  | MISO            | EIC/EXTINT[2]                        PTC/X[6]  SERCOM1/PAD[2] *SERCOM3/PAD[2] +TC3/WO[0]    TCC0/WO[2]
 * | 44         | 13               |  PA19  | SCK, LED        | EIC/EXTINT[3]                        PTC/X[7]  SERCOM1/PAD[3] *SERCOM3/PAD[3] +TC3/WO[1]    TCC0/WO[3]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * |            | USB              |        |                 |
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTB, 17, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM6_CH0, TC6_CH0, EXTERNAL_INT_1 },   	// D4, TC6/WO[0]
  { PORTA, 22, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM4_CH0, TC4_CH0, EXTERNAL_INT_6 }, 		// D5, TC4/WO[0]
  ...
  { PORTB,  5, PIO_DIGITAL, {PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 }, 						// IGT
  { PORTB,  6, PIO_DIGITAL, {PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 }, 						// EMERG_OFF
  { PORTB,  7, PIO_DIGITAL, {PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, 						// STATUS
  ...
  // 45/46 - USB
  // --------------------
  { PORTA, 24, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, 								// 45, USB/DM
  { PORTA, 25, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, 								// 46, USB/DP
  
  // 47 - DUMMY
  // ----------
  { PORTB, 11, PIO_DIGITAL, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, 							// 47, DUMMY
